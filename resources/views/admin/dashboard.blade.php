                    ...
                    <div class="d-flex flex-wrap align-items-center justify-content-between gap-1 mb-8">
                        <div class="d-flex align-items-center gap-10">
                            <span class="mb-0 w-48-px h-48-px bg-cyan-600 flex-shrink-0 text-white d-flex justify-content-center align-items-center rounded-circle h6 mb-0">
                                <img src="AdminAssets/images/home-eleven/icons/home-eleven-icon1.svg" alt="">
                            </span>
                            <div>
                    ...
                    <div class="d-flex flex-wrap align-items-center justify-content-between gap-1 mb-8">
                        <div class="d-flex align-items-center gap-10">
                            <span class="mb-0 w-48-px h-48-px bg-warning-600 flex-shrink-0 text-white d-flex justify-content-center align-items-center rounded-circle h6 mb-0">
                                <img src="AdminAssets/images/home-eleven/icons/home-eleven-icon2.svg" alt="">
                            </span>
                            <div>
                    ...
                    <div class="d-flex flex-wrap align-items-center justify-content-between gap-1 mb-8">
                        <div class="d-flex align-items-center gap-10">
                            <span class="mb-0 w-48-px h-48-px bg-lilac-600 flex-shrink-0 text-white d-flex justify-content-center align-items-center rounded-circle h6 mb-0">
                                <img src="AdminAssets/images/home-eleven/icons/home-eleven-icon3.svg" alt="">
                            </span>
                            <div>
                    ...
                    <div class="d-flex flex-wrap align-items-center justify-content-between gap-1 mb-8">
                        <div class="d-flex align-items-center gap-10">
                            <span class="mb-0 w-48-px h-48-px bg-success-600 flex-shrink-0 text-white d-flex justify-content-center align-items-center rounded-circle h6 mb-0">
                                <img src="AdminAssets/images/home-eleven/icons/home-eleven-icon4.svg" alt="">
                            </span>
                            <div>
                                    ...
                                    <div class="d-flex align-items-center justify-content-between gap-3">
                                        <div class="d-flex align-items-center w-100 gap-12">
                                            <span class="w-40-px h-40-px rounded-circle d-flex justify-content-center align-items-center bg-primary-100">
                                                <img src="AdminAssets/images/home-eleven/icons/earn-cat-icon1.svg" alt="" class="">
                                            </span>
                                            <div class="flex-grow-1">
                                                <h6 class="text-sm mb-0">Digital AdminAssets</h6>
                                    ...
                                    <div class="d-flex align-items-center justify-content-between gap-3">
                                        <div class="d-flex align-items-center w-100 gap-12">
                                            <span class="w-40-px h-40-px rounded-circle d-flex justify-content-center align-items-center bg-danger-100">
                                                <img src="AdminAssets/images/home-eleven/icons/earn-cat-icon2.svg" alt="" class="">
                                            </span>
                                            <div class="flex-grow-1">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between gap-3">
                                        <div class="d-flex align-items-center w-100 gap-12">
                                            <span class="w-40-px h-40-px rounded-circle d-flex justify-content-center align-items-center bg-warning-200">
                                                <img src="AdminAssets/images/home-eleven/icons/earn-cat-icon3.svg" alt="" class="">
                                            </span>
                                            <div class="flex-grow-1">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between gap-3">
                                        <div class="d-flex align-items-center w-100 gap-12">
                                            <span class="w-40-px h-40-px rounded-circle d-flex justify-content-center align-items-center bg-success-200">
                                                <img src="AdminAssets/images/home-eleven/icons/earn-cat-icon4.svg" alt="" class="">
                                            </span>
                                            <div class="flex-grow-1">
                        ...
                        <div class="card radius-16">
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-center justify-content-between pb-10 mb-10 border-bottom border-neutral-200">
                                    <div class="">
                                        <h6 class="text-md mb-0">Digital AdminAssets</h6>
                    ...
                    <div class="card-body p-0">
                        <div class="p-20">
                            <div class="position-relative z-1 py-32 text-center px-3">
                                <img src="AdminAssets/images/home-eleven/bg/bg-orange-gradient.png" alt="" class="position-absolute top-0 start-0 w-100 h-100 z-n1">
                            ...
                            <div class="officer-slider">
                                <div class="officer-slider__item d-flex flex-column text-center align-items-center justify-content-center">
                                    <div class="officer-slider__thumb w-56-px h-56-px rounded-circle overflow-hidden flex-shrink-0 mx-8">
                                        <img src="AdminAssets/images/home-eleven/officer-img1.png" alt="" class="w-100 h-100 object-fit-cover">
                                    </div>
                                ...
                                <div class="officer-slider__item d-flex flex-column text-center align-items-center justify-content-center">
                                    <div class="officer-slider__thumb w-56-px h-56-px rounded-circle overflow-hidden flex-shrink-0 mx-8">
                                        <img src="AdminAssets/images/home-eleven/officer-img2.png" alt="" class="w-100 h-100 object-fit-cover">
                                    </div>
                                    <div class="officer-slider__content mt-24 min-w-max-content">
                                ...
                                <div class="officer-slider__item d-flex flex-column text-center align-items-center justify-content-center">
                                    <div class="officer-slider__thumb w-56-px h-56-px rounded-circle overflow-hidden flex-shrink-0 mx-8">
                                        <img src="AdminAssets/images/home-eleven/officer-img3.png" alt="" class="w-100 h-100 object-fit-cover">
                                    </div>
                                    <div class="officer-slider__content mt-24 min-w-max-content">
                                ...
                                <div class="officer-slider__item d-flex flex-column text-center align-items-center justify-content-center">
                                    <div class="officer-slider__thumb w-56-px h-56-px rounded-circle overflow-hidden flex-shrink-0 mx-8">
                                        <img src="AdminAssets/images/home-eleven/officer-img4.png" alt="" class="w-100 h-100 object-fit-cover">
                                    </div>
                                    <div class="officer-slider__content mt-24 min-w-max-content">
                                ...
                                <div class="officer-slider__item d-flex flex-column text-center align-items-center justify-content-center">
                                    <div class="officer-slider__thumb w-56-px h-56-px rounded-circle overflow-hidden flex-shrink-0 mx-8">
                                        <img src="AdminAssets/images/home-eleven/officer-img5.png" alt="" class="w-100 h-100 object-fit-cover">
                                    </div>
                                    <div class="officer-slider__content mt-24 min-w-max-content">
                    ...
                    <div class="card-body py-20">
                        ...
                        <div class="mt-40 mb-24 text-center pe-110 position-relative max-w-288-px mx-auto">
                            <div class="w-170-px h-170-px rounded-circle z-1 position-relative d-inline-flex justify-content-center align-items-center border border-white border-width-2-px">
                                <img src="AdminAssets/images/home-eleven/bg/radial-bg1.png" alt="" class="position-absolute top-0 start-0 z-n1 w-100 h-100 object-fit-cover">
                            ...
                            <div class="w-144-px h-144-px rounded-circle z-1 position-relative d-inline-flex justify-content-center align-items-center border border-white border-width-3-px position-absolute top-0 end-0 mt--36">
                                <img src="AdminAssets/images/home-eleven/bg/radial-bg2.png" alt="" class="position-absolute top-0 start-0 z-n1 w-100 h-100 object-fit-cover">
                            ...
                            <div class="w-110-px h-110-px rounded-circle z-1 position-relative d-inline-flex justify-content-center align-items-center border border-white border-width-3-px position-absolute bottom-0 start-50 translate-middle-x ms-48">
                                <img src="AdminAssets/images/home-eleven/bg/radial-bg3.png" alt="" class="position-absolute top-0 start-0 z-n1 w-100 h-100 object-fit-cover">
                ...
                <table class="table bordered-table sm-table mb-0">
                  ...
                  <tbody>
                    <tr>
                      <td class="">
                        <div class="d-flex align-items-center">
                          <img src="AdminAssets/images/users/user1.png" alt="" class="w-40-px h-40-px rounded-circle flex-shrink-0 me-12 overflow-hidden">
                          <div class="flex-grow-1">
                    ...
                    <tr>
                      <td class="">
                        <div class="d-flex align-items-center">
                          <img src="AdminAssets/images/users/user2.png" alt="" class="w-40-px h-40-px rounded-circle flex-shrink-0 me-12 overflow-hidden">
                          <div class="flex-grow-1">
                    ...
                    <tr>
                      <td class="">
                        <div class="d-flex align-items-center">
                          <img src="AdminAssets/images/users/user3.png" alt="" class="w-40-px h-40-px rounded-circle flex-shrink-0 me-12 overflow-hidden">
                          <div class="flex-grow-1">
                    ...
                    <tr>
                      <td class="">
                        <div class="d-flex align-items-center">
                          <img src="AdminAssets/images/users/user4.png" alt="" class="w-40-px h-40-px rounded-circle flex-shrink-0 me-12 overflow-hidden">
                          <div class="flex-grow-1">
                    ...
                    <tr>
                      <td class="">
                        <div class="d-flex align-items-center">
                          <img src="AdminAssets/images/users/user5.png" alt="" class="w-40-px h-40-px rounded-circle flex-shrink-0 me-12 overflow-hidden">
                          <div class="flex-grow-1">
